...
nacos整体架构分为用户层、业务层、内核层和插件，

- 用户层主要解决用户的易用性问题
- 业务层主要解决服务发现和配置管理的功能问题
- 内核层解决分布式系统一致性、存高可用等核心问题
- 插件结局扩展性问题

<img src="doc/nacos 整体架构分层图.png" alt="nacos 架构" style="zoom:50%;" />
...
- NameService：解决 Namespace 到 ClusterID 的路由问题，解决用户环境与 Nacos 物理环境映射问题
- CMDB：解决元数据存储，与三方 CMDB 系统对接问题，解决应用、人、资源之间的关系
...
<img src="doc/Nacos 临时实例健康检查.jpg" alt="目录位置" style="zoom: 33%;" />
...
<img src="doc/Nacos 持久实例健康检查.jpg" alt="目录位置" style="zoom: 33%;" />
